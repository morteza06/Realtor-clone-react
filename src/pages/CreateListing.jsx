  ...
  return (
    <main className='max-w '>
        ...
        <form >
            ...
            <div className="flex items-center mb-6">
                <div>
                    ...
                    <div className="flex w-full justify-center items-center space-x-6">
                        ...
                        {type === "rent" && (
                            <div>
                                <p className="text-md w-full whitespace-nowarp">$ / Month</p>
                            </div>
                        )}
                    </div>
                </div>
            ...
            <button type="submit" className="mb-6 w-full px-7 py-3 bg-blue-600 text-white font-medium text-sm uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg
